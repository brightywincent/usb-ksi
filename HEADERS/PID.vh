...
//TOKEN PID nibs
`define PIDN_OUT 8'b1110_0001
`define PIDN_SOF 8'b1010_0101
`define PIDN_IN 8'b0110_1001
`define PIDN_SETUP 8'b0010_1101

//DATA PID nibs
`define PIDN_DATA0 8'b1100_0011
`define PIDN_DATA2 8'b1000_0111
`define PIDN_DATA1 8'b0100_1011
`define PIDN_MDATA 8'b0000_1111

//HANDSHAKE PID nibs
`define PIDN_ACK 8'b1101_0010
`define PIDN_NYET 8'b1001_0110
`define PIDN_NAK 8'b0101_1010
`define PIDN_STALL 8'b0001_1110

//SPECIAL PID nibs
`define PIDN_PING 8'b1011_0100
`define PIDN_SPLIT 8'b0111_1000
`define PIDN_PRE 8'b0011_1100

`define PIDN_INVALID 8'b0000_0000
